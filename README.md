...
설치가 완료되면 `shiftee-analyze` 명령어를 어디서든 사용할 수 있습니다.
...
# 해결 방법 2: 파일 경로 직접 지정
shiftee-analyze --data1 path/to/file1.xlsx --data2 path/to/file2.xlsx --start 2025-11-01 --end 2025-11-30
```
