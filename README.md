...
- `mise`
- `mise install` 로 사용할 수 있는 Python 3.12 / uv
...
쉘에 `mise` 활성화가 안 되어 있다면 아래처럼 실행하면 됩니다.
...
**스크립트 기능:**
- ✅ 프로젝트 루트 자동 이동
- ✅ `mise exec` 를 통한 Python/uv 환경 고정
- ✅ 오류 발생 시 즉시 중단
- ✅ 성공/실패 상태 출력
...
# 2. 브라우저 표시 모드로 디버깅
SHIFTEE_HEADLESS=false shiftee-analyze --download
```
